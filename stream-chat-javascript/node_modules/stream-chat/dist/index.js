  ...
  _createClass__default['default'](ChannelState, [{
    ...
    value: function addReaction(reaction, message, enforce_unique) {
      ...
      this._updateMessage(message, function (msg) {
        var newMsg = _this2._addReactionToMessage(msg, reaction, enforce_unique);

        messageWithReaction = _objectSpread(_objectSpread({}, messageWithReaction), {}, {
    ...
    value: function _removeOwnReactionFromMessage(message, reaction) {
      if (message.own_reactions) {
        message.own_reactions = message.own_reactions.filter(function (item) {
    ...
    value: function removeReaction(reaction, message) {
      ...
      this._updateMessage(message, function (msg) {
        _this3._removeOwnReactionFromMessage(msg, reaction);
  ...
  _createClass__default['default'](StreamChat, [{
    ...
    */
    ...
    value: function getUserAgent() {
      return this.userAgent || "stream-chat-javascript-client-".concat(this.node ? 'node' : 'browser', "-", "3.1.0");
    }
  }, {
    key: "setUserAgent",
